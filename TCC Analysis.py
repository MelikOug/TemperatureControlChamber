...
clock, meanT, minT, maxT, std = np.loadtxt(
    'C:\\Users\\mdo21\\OneDrive - Imperial College London\\Documents\\TCC Osc Data\\TCC_Data_Osc20.txt', unpack=True, dtype=str)
...
clock2, PTemp = np.loadtxt(
    'Peltier_Osc20.txt', unpack=True, usecols=(1, 3), dtype=str, skiprows=1)
